            ...
            <form>
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="nfantasia" value="{{$clientes->nfantasia}}" disabled>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="celular" value="{{$clientes->celular}}" disabled>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        <input type="text" value="{{$clientes->rgi}}" name="rgi" disabled>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="pais" value="{{$clientes->pais}}" disabled>
                    </div>
                    <div class="">
