        ...
        @if($vetProd)
            <div class="accordion">
                <div x-data="{ open: false }">
                    <button @click.prevent class="accordion-header" @click="open = !open">Opções de
                        preço</button>
                    <div class="accordion-content" x-show="open" x-transition>
                        <div class="contentInput">
                            ...
                            <input class="inputWrapper w50 number" type="number" min="0" wire:model="percadicional"
                                name="percadicional" min="0" placeholder="Custo adiocional %">
                            <button @click.prevent wire:click="calcularOutros">
                                Calcular
                            </button>
                        </div>
                    </div>
